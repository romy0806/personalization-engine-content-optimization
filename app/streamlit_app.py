...
st.write(
    "For the selected segment, prioritize content that combines demonstrated intent, "
    "category affinity, and conversion proximity. Use experimentation to validate "
    "incremental lift before scaling."
)
